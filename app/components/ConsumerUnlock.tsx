  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', top: 28, right: 32, zIndex: 10, display: 'flex', alignItems: 'center', gap: 8 }}>
        <div style={{ width: 6, height: 6, borderRadius: '50%', background: 'var(--q-green)', boxShadow: '0 0 10px var(--q-green)', animation: 'breathe 2s ease-in-out infinite' }} />
        <span style={{ color: 'rgba(120,160,220,0.45)', fontSize: '9px', fontFamily: 'var(--font-mono)', letterSpacing: '0.22em', textTransform: 'uppercase' }}>QAP · SECURE NODE</span>
      </div>
      ...
      <div style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: 440 }}>
        ...
        >
          ...
          <div style={{ position: 'relative', marginBottom: error ? 10 : 20 }}>
            <input
              ...
              style={{
                ...
                borderRadius: 16, color: 'var(--q-text)', fontSize: 22,
                fontFamily: 'var(--font-mono)', outline: 'none', textAlign: 'center',
                letterSpacing: '0.4em', boxSizing: 'border-box',
                boxShadow: focused ? '0 0 0 3px rgba(0,212,255,0.1), 0 0 30px rgba(0,212,255,0.15), inset 0 1px 0 rgba(0,212,255,0.08)' : 'inset 0 1px 0 rgba(255,255,255,0.04)',
          ...
          {error && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, background: 'rgba(255,56,96,0.07)', border: '1px solid rgba(255,56,96,0.2)', borderRadius: 12, padding: '10px 16px', marginBottom: 16 }}>
          ...
          <button
            ...
            style={{
              width: '100%',
              background: password && !loading ? 'linear-gradient(135deg, #00D4FF 0%, #0088bb 50%, #7C3AFF 100%)' : 'rgba(255,255,255,0.04)',
              color: password && !loading ? '#000' : 'rgba(120,160,220,0.3)',
              border: password && !loading ? 'none' : '1px solid rgba(255,255,255,0.07)',
              borderRadius: 16, padding: '17px', fontSize: '13px', fontWeight: 800,
              fontFamily: 'var(--font-syne)', letterSpacing: '0.18em', textTransform: 'uppercase',
              cursor: password && !loading ? 'pointer' : 'not-allowed',
              boxShadow: password && !loading ? '0 0 40px rgba(0,212,255,0.4), 0 0 80px rgba(124,58,255,0.2), 0 4px 20px rgba(0,0,0,0.5)' : 'none',
